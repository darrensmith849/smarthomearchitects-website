  ...
  return (
    <div className={`aura-product-page scenario-${scenario.id}`} style={auraStyle}>
      ...
      <section className="aura-presence-lab" id="aura-presence-lab">
        <div className="aura-lab-head"><div className="section-label section-label-light"><span>01</span><span>Presence laboratory</span></div><div><p className="eyebrow eyebrow-light">Stillness is not absence</p><h2>A room that<br />knows the difference.</h2></div><p>Aura combines fine-motion radar with environmental context. Choose a moment to see the signals become one useful room state.</p></div>
