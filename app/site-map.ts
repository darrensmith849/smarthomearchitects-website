...
export const systemPages = [
  { slug: "architecture", number: "01", title: "System architecture", headline: "One invisible foundation.", intro: "The technical backbone that lets every discipline behave like part of one home.", image: "/images/atlas.webp", topics: ["Open standards", "Control hierarchy", "Future capacity"] },
  { slug: "interfaces", number: "02", title: "Interfaces", headline: "Control without complexity.", intro: "Tactile controls, quiet screens and voice only where each is genuinely useful.", image: "/images/axis.webp", topics: ["Keypads", "Touch interfaces", "Voice and presence"] },
  { slug: "scenes", number: "03", title: "Scenes & automations", headline: "Many systems. One moment.", intro: "Scenes compose light, shade, temperature and sound around real household rituals.", image: "/images/service-lighting.webp", topics: ["Daily rhythm", "Context", "Manual always wins"] },
  { slug: "privacy", number: "04", title: "Privacy", headline: "The intelligence stays at home.", intro: "Local processing, data restraint and explicit consent are designed into the system from the start.", image: "/images/aura.webp", topics: ["Local-first", "Least data", "Auditable access"] },
  { slug: "resilience", number: "05", title: "Resilience", headline: "Ready for the imperfect day.", intro: "Power, network and control continue gracefully through outages, failures and change.", image: "/images/atlas.webp", topics: ["Graceful failure", "Documented recovery", "Long service life"] },
  { slug: "wellness", number: "06", title: "Wellness", headline: "A home in rhythm with you.", intro: "Light, air, temperature and quiet are tuned around rest, focus and natural daily cycles.", image: "/images/courtyard.webp", topics: ["Circadian light", "Air quality", "Acoustic calm"] },
];

export const studioPages = [
  { slug: "philosophy", number: "02", title: "Philosophy", headline: "Technology should return attention.", intro: "We believe the smartest home is the one that asks the least from the people inside it.", image: "/images/hero.webp" },
  { slug: "team", number: "03", title: "The studio", headline: "Architects of the invisible.", intro: "A multidisciplinary team working across experience, engineering, lighting, acoustics and long-term care.", image: "/images/courtyard.webp" },
  { slug: "partners", number: "04", title: "Partners", headline: "Designed with the whole table.", intro: "We work in close collaboration with architects, interior designers, consultants, contractors and trusted makers.", image: "/images/service-shading.webp" },
];

export const categoryPages = [
  { slug: "controls", title: "Controls", headline: "One touch. No second thought.", intro: "Keypads and interfaces selected for tactility, clarity and architectural fit.", image: "/images/axis.webp", filter: "Touch" },
  { slug: "sensors", title: "Sensors", headline: "Context without intrusion.", intro: "Presence and environmental sensing designed to inform the home while protecting privacy.", image: "/images/aura.webp", filter: "Sense" },
  { slug: "processors", title: "Processors", headline: "Local intelligence, quietly working.", intro: "The resilient control cores and gateways that keep essential experience inside the home.", image: "/images/atlas.webp", filter: "Think" },
  { slug: "speakers", title: "Architectural audio", headline: "Sound, not hardware.", intro: "Invisible, flush and sculptural loudspeakers for every level of listening.", image: "/images/service-audio.webp", filter: "Listen" },
  { slug: "shades", title: "Shades", headline: "Daylight, precisely edited.", intro: "Sheer, blackout and exterior systems coordinated into the architecture.", image: "/images/service-shading.webp", filter: "Filter" },
  { slug: "climate", title: "Climate", headline: "Comfort in context.", intro: "Room sensors, quiet controls and plant integration for a naturally settled home.", image: "/images/courtyard.webp", filter: "Breathe" },
  { slug: "networking", title: "Networking", headline: "Infrastructure for modern life.", intro: "Enterprise-grade networks and resilient power made appropriate for a private home.", image: "/images/atlas.webp", filter: "Connect" },
  { slug: "security", title: "Security", headline: "Confidence, not surveillance.", intro: "Private, local-first security components selected as part of a layered design.", image: "/images/service-security.webp", filter: "Protect" },
];

export const projectPages = [
  { slug: "atlantic-house", title: "Atlantic House", location: "Bantry Bay", year: "2026", line: "Blue hour, composed.", image: "/images/hero.webp", systems: "Lighting · shading · audio · climate" },
  { slug: "forest-house", title: "Forest House", location: "Constantia", year: "2025", line: "A home that breathes with the garden.", image: "/images/courtyard.webp", systems: "Climate · wellness · security · energy" },
  { slug: "city-penthouse", title: "City Penthouse", location: "Johannesburg", year: "2026", line: "Quiet above the city.", image: "/images/service-audio.webp", systems: "Audio · lighting · privacy · networking" },
  { slug: "wine-estate", title: "Wine Estate", location: "Stellenbosch", year: "2025", line: "Old landscape. New intelligence.", image: "/images/service-security.webp", systems: "Whole home · energy · security · shading" },
];
...
export const architectureLinks: LinkItem[] = [
  ...
  { label: "Water & Landscape Atelier", href: "/experience/water-landscape-atelier" },
